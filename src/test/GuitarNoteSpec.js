...
describe("GuitarNote", function() {
  ...
  it("errors if provided invalid string values", function() {
  ...
  it("errors if provided invalid fret values", function() {
  ...
  it("isMuted works properly", function() {
    var gn;

    gn = new GuitarNote(2, 5);
    expect(gn.isMuted()).toBe(false);

    gn = new GuitarNote(2, "x");
    expect(gn.isMuted()).toBe(true);
    gn = new GuitarNote(2, "m");
    expect(gn.isMuted()).toBe(true);
    gn = new GuitarNote(2, 2, { muted: true });
    expect(gn.isMuted()).toBe(true);
  });
  ...
  it("toString works properly", function() {
    ...
    expect(gn.toString())
      .toEqual("String: 2, Fret: 3, Finger: " + GuitarNote.DEF_MUTE_ANNOTATION);
  });
